@echo off
rem ===========================================================================
rem  Hold FEATURE updates for 6 months (180 days) and pin this machine to the
...
rem ===========================================================================
setlocal
title Update deferral - 6 months
cd /d "%~dp0"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Set-UpdateDeferral.ps1" -Months 6
