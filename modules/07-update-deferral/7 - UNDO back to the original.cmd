@echo off
rem ===========================================================================
rem  Put everything back to how it was before this module was EVER used, from
rem  the write-once original-state.json.
rem  
rem  Use this if you have applied a hold more than once and want the machine as
rem  it was at the very start.
rem
rem  THIS ONE NEEDS ADMINISTRATOR RIGHTS. Windows Update policy is machine-wide.
rem ===========================================================================
setlocal
title Update deferral - undo to original
cd /d "%~dp0"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Restore-UpdateDeferral.ps1" -Original
