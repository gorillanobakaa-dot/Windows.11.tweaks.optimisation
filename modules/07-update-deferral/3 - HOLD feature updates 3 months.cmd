@echo off
rem ===========================================================================
rem  Hold FEATURE updates for 3 months (90 days) and pin this machine to the
rem  Windows release it is already running.
rem  
rem  SECURITY UPDATES ARE NOT TOUCHED. They keep arriving monthly. This holds
rem  back the big twice-yearly feature releases, not the patches.
rem  
rem  It backs up first and proves the backup was written. If the backup fails,
rem  it changes nothing.
rem
rem  THIS ONE NEEDS ADMINISTRATOR RIGHTS. Windows Update policy is machine-wide.
rem ===========================================================================
setlocal
title Update deferral - 3 months
cd /d "%~dp0"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Set-UpdateDeferral.ps1" -Months 3
