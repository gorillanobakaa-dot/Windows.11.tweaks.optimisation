@echo off
rem  Disables the 5 Xbox services + 1 scheduled task, with a verified backup first.
rem  NEEDS ADMINISTRATOR RIGHTS: service configuration lives under HKLM.
setlocal
title Xbox services - apply
cd /d "%~dp0"
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Disable-XboxServices.ps1"
echo.
