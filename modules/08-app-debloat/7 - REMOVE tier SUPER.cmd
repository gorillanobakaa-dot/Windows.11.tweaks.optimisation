@echo off
rem ===========================================================================
rem  REMOVES the MODERATE tier plus the third-party Store apps and remaining
rem  extras: WhatsApp, Adobe Express, Glance, Lenovo Settings for Enterprise,
rem  new Outlook, Camera and PHOTOS.
rem  
rem  REMOVING PHOTOS LEAVES NO DEFAULT IMAGE VIEWER unless you install one.
rem  
...
rem ===========================================================================
setlocal
title App de-bloat - remove SUPER
cd /d "%~dp0"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Remove-Apps.ps1" -Tier super
