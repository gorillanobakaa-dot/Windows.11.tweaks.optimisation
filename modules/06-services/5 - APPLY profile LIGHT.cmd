@echo off
rem  Applies the LIGHT profile. Backup of every start type first.
rem  NEEDS ADMINISTRATOR RIGHTS: service start types are machine-wide.
setlocal
title Services - apply LIGHT
cd /d "%~dp0"
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Apply-ServiceProfile.ps1" -Profile light
echo.
