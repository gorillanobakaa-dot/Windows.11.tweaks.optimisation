@echo off
rem  Applies the SUPER / enterprise-secure profile. Read the preview first.
rem  NEEDS ADMINISTRATOR RIGHTS: service start types are machine-wide.
setlocal
title Services - apply SUPER
cd /d "%~dp0"
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Apply-ServiceProfile.ps1" -Profile super
echo.
