@echo off
rem  Applies the MODERATE profile. Backup of every start type first.
rem  NEEDS ADMINISTRATOR RIGHTS: service start types are machine-wide.
setlocal
title Services - apply MODERATE
cd /d "%~dp0"
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Apply-ServiceProfile.ps1" -Profile moderate
echo.
